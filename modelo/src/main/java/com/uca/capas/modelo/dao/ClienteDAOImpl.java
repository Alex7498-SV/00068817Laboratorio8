...
public class ClienteDAOImpl implements ClienteDAO {
	...
	@Override
	public int insertClienteAutoId(Cliente c) throws DataAccessException{
	...
	public static final String sql = "UPDATE store.cliente SET s_nombres =?, s_apellidos=?, f_nacimiento=?, b_activo=? WHERE c_cliente=?";
